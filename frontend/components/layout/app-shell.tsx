  ...
  const Sidebar = (
    <aside className="flex h-full w-64 flex-col border-r bg-background/95 px-3 py-4">
      <Link href="/dashboard" className="mb-6 flex items-center gap-3 px-2">
        ...
        <span>
          <span className="block text-base font-semibold">TeamTask</span>
          <span className="block text-xs text-muted-foreground">Delivery workspace</span>
        </span>
      </Link>
      ...
      <div className="app-surface mt-auto rounded-lg border p-3">
        <div className="flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/10 text-primary">
            <Rocket className="h-4 w-4" />
          </span>
          <div>
            <p className="text-xs font-medium">Railway-ready build</p>
            <p className="text-xs text-muted-foreground">Frontend and API deploy configs included</p>
          </div>
        </div>
      </div>
    </aside>
